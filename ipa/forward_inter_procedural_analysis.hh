...
#ifndef FORWARD_INTER_PROCEDURAL_ANALYSIS
#define FORWARD_INTER_PROCEDURAL_ANALYSIS
...
class forward_inter_procedural_analysis: public inter_procedural_analysis<value_type, dept_value_type>
{
...
public:
        ...
        using inter_procedural_analysis<value_type, dept_value_type>::get_function_dependent_context;
        using inter_procedural_analysis<value_type, dept_value_type>::is_recursively_called;
        using inter_procedural_analysis<value_type, dept_value_type>::is_reachable_context_unprocessed;
	...
	virtual void process_in_value (context<value_type, dept_value_type> * current_context, basic_block current_block) = 0;
	...
	bool compute_in_single_pred (context<value_type, dept_value_type> * current_context, basic_block current_block);
	void compute_in_multiple_pred (context<value_type, dept_value_type> * current_context, basic_block current_block);
	void compute_out (context<value_type, dept_value_type> * current_context, basic_block current_block);
	void copy_in_to_out (context<value_type, dept_value_type> * current_context, basic_block current_block);
	dept_value_type * get_dependent_context_in_value (struct cgraph_node * function);
